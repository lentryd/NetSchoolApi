...
exports.FetchError = exports.WorkError = exports.reportFile = exports.hash = exports.md5 = void 0;
...
function reportFile(link, data) {
    ...
    return this.fetch("/WebApi/signalr/negotiate" +
        ...
        .then(function (id) {
        return _this.fetch("/webapi/files/" + id, { headers: { at: _this._at } });
    })
